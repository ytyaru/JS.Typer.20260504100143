...
class Footer {
    ...
    #copyright() { return small('©', time({datetime:this._created}, '20260504100139'), this.#author()) }
    ...
    #project() { return a(this.#externalLinkAttr(({href:`https://github.com/${this._author}/Typer/`})), img({class:'icon', src:`${this._prePath}asset/image/logo/github/black.svg`})) }

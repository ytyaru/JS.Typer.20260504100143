...
//    static cal() {return this.#data([...this.fn(), ...this.cls()].flatMap(v=>v))}
    ...
    static fn() {return this.#data([()=>{}, async()=>{}, this.#C.M, this.#C.AM, this.#C.GM, this.#C.AGM, this.#c.m, this.#c.am, this.#c.gm, this.#c.agm, Array.prototype.map, (function(){}).bind(null), function(){}, function fn(){}, async function afn(){}, function *gfn(){}, async function *agfn(){}])}

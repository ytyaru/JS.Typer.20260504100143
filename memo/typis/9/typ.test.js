    ...
    describe('des',()=>{
        describe('o',()=>{
            test('v',()=>{
                ...
                const v = Object.getOwnPropertyDescriptor(o,'v');
                expect(getTag(v)).toBe('Descriptor.Data<Value>')
            });
            test('fn',()=>{
                const o = {}
                Object.defineProperty(o,'v',{value:()=>1});
                const v = Object.getOwnPropertyDescriptor(o,'v');
                expect(getTag(v)).toBe('Descriptor.Data<Function>')
            });
            test('get',()=>{
                const o = {}
                Object.defineProperty(o,'v',{get:()=>1});
                const v = Object.getOwnPropertyDescriptor(o,'v');
                expect(getTag(v)).toBe('Descriptor.Accessor<Getter>')
            });
            test('set',()=>{
                const o = {}
                Object.defineProperty(o,'v',{set:(v)=>1});
                const v = Object.getOwnPropertyDescriptor(o,'v');
                expect(getTag(v)).toBe('Descriptor.Accessor<Setter>')
            });
            test('accessor',()=>{
                const o = {}
                Object.defineProperty(o,'v',{get:(v)=>1,set:(v)=>1});
                const v = Object.getOwnPropertyDescriptor(o,'v');
                expect(getTag(v)).toBe('Descriptor.Accessor<Getter,Setter>')
            });
        });
        describe('cls',()=>{
            test('get',()=>{
                const v = Object.getOwnPropertyDescriptor(P,'sg');
                expect(getTag(v)).toBe('Descriptor.Accessor<Getter>')
            });
            test('set',()=>{
                const v = Object.getOwnPropertyDescriptor(P,'ss');
                expect(getTag(v)).toBe('Descriptor.Accessor<Setter>')
            });
            test('accessor',()=>{
                const v = Object.getOwnPropertyDescriptor(P,'sgs');
                expect(getTag(v)).toBe('Descriptor.Accessor<Getter,Setter>')
            });
        });
        describe('ins',()=>{
            test('get',()=>{
                const v = Object.getOwnPropertyDescriptor(P.prototype,'g');
                expect(getTag(v)).toBe('Descriptor.Accessor<Getter>')
            });
            test('set',()=>{
                const v = Object.getOwnPropertyDescriptor(P.prototype,'s');
                expect(getTag(v)).toBe('Descriptor.Accessor<Setter>')
            });
            test('accessor',()=>{
                const v = Object.getOwnPropertyDescriptor(P.prototype,'gs');
                expect(getTag(v)).toBe('Descriptor.Accessor<Getter,Setter>')
            });
        });
    });
...
describe('typof', ()=>{
    ...
    describe('(v,C)', () => {
        describe('true', () => {
            ...
            // typis/typof差異: DescriptorもObject判定される
            test.each(['g s gs'.split(' ').map(k=>Object.getOwnPropertyDescriptor(P,'s'+k))])(`des(%p)`,v=>expect(typof(v,Object)).toBe(true));
...
describe('typis', ()=>{
    ...
    describe('(v,C)', () => {
        ...
        describe('false', () => {
            ...
            // typis/typof差異: Object.create(null)
            ...
            // typis/typof差異: DescriptorはObject判定されない
            test.each(['g s gs'.split(' ').map(k=>Object.getOwnPropertyDescriptor(P,'s'+k))])(`des(%p)`,v=>expect(typis(v,Object)).toBe(false));
            test.each([[NaN],[null],[undefined],[false],[Infinity],[0],[''],[0n],[Symbol()],[{}],[Object.create(null)],[Object.create({})],[[]],[new Date()]])('(%p,Function)',(v)=>{
...
describe('Typ', () => {
    ...
    describe('throw', () => {
        const T = Typ.throw;
        test('instanceof', () => expect(T).toBeInstanceOf(Typ));
        describe('is()', () => {
            describe('true', () => {
                test('(0,Number)',()=>expect(typer(0,Number)).toBe(true));
                test.each([[new P(), P],[new C(),C]])('(%p,%p)',(v,C)=>{
            ...
            describe('Error', () => {
                test.each([[new Boolean(),Boolean]])('(%p,%p)',(v,C)=>{
                    try{T.is(v,C);expect.unreachable();}catch(e){
                        expect(e).toBeInstanceOf(Error)
                        expect(e.message).toBe(`不正な値です。BoxedPrimitive<${C.name}>`);
                    }
                });
                test.each([[0,String],[new C(),P]])('(%p,%p)',(v,C)=>{
                    try{T.is(v,C);expect.unreachable();}catch(e){
        ...
        describe('of()', () => {
            ...
            describe('Error', () => {
                test.each([[new Boolean(),Boolean]])('(%p,%p)',(v,C)=>{
                    try{T.of(v,C);expect.unreachable();}catch(e){
                        expect(e).toBeInstanceOf(Error)
                        expect(e.message).toBe(`不正な値です。BoxedPrimitive<${C.name}>`);
                    }
                });
        ...
        describe('as()', () => {
            describe('true', () => {
                test.each([[NaN,'NaN'],[null,'Null'],[undefined,'Undefined']])(`(%p,%p)`,(v,C)=>{
            ...
            describe('Error', () => {
                test.each([[new Boolean(),Boolean]])('(%p,%p)',(v,C)=>{
                    try{T.as(v,C);expect.unreachable();}catch(e){
                        expect(e).toBeInstanceOf(Error)
                        expect(e.message).toBe(`不正な値です。BoxedPrimitive<${C.name}>`);
                    }
                });
